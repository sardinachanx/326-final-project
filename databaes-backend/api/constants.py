COURSE_SUBJECTS = [
    ...
    ("ARABIC", "Arabic"),
    ("ARCH", "Architecture"),
    ("ARCH-DES", "Architecture and Design"),
    ("ART", "Art"),
    ...
    ("ASTRON", "Astronomy"),
    ("BDIC", "Bachelor's Deg. W/Indiv Conc."),
    ("BIOCHEM", "Biochemistry & Molecular Bio."),
    ("BIOLOGY", "Biology"),
    ("BI@MIC", "Biology @ MIC"),
    ("BMED-ENG", "Biomedical Engineering"),
    ("BIOSTATS", "Biostatistics"),
    ("BIOST&EP", "Biostats & Epidemiology"),
    ...
    ("CHEM", "Chemistry"),
    ("CHINESE", "Chinese"),
    ("CE-ENGIN", "Civil & Environmental Engrg"),
    ("CLASSICS", "Classics"),
    ("CC@MIC", "College Curriculum @ MCI"),
    ...
    ("ECON", "Economics"),
    ("EDUC", "Education"),
    ("ED@MIC", "Education @ MIC"),
    ("E&C-ENG", "Electrical & Computer Engin"),
    ("ENGIN", "Engineering"),
    ("ENGLISH", "English"),
    ...
    ("HPP", "Health Promotion & Policy"),
    ("HEBREW", "Hebrew"),
    ("HERIT", "Heritage Studies"),
    ("HISPAN", "Hispanic Lit. & Linguistics"),
    ("HISTORY", "History"),
    ("HI@MIC", "History @ MIC"),
    ("HONORS", "Honors College"),
    ("HT-MGT", "Hospitality & Tourism Managmnt"),
    ("HUMANDEV", "Human Development"),
    ("HU@MIC", "Humanities @ MIC"),
    ("HM&FNART", "Humanities and Fine Arts"),
    ("INFO", "Informatics"),
    ("INFOSEC", "Information Security"),
    ("IALS", "Inst for Applied Life Sciences"),
    ("INTERPRT", "Interpreter's Studies"),
    ...
    ("LI@MIC", "Literature Elective @ MIC"),
    ("MANAGMNT", "Management"),
    ("MARKETNG", "Marketing"),
    ("MATH", "Mathematics"),
    ("MA@MIC", "Mathematics @ MIC"),
    ("M&I-ENG", "Mechanical & Industrial Engrg"),
    ("MICROBIO", "Microbiology"),
    ("MIDEAST", "Middle Eastern Studies"),
    ("MILITARY", "Military Leadership"),
    ("EURO", "Modern European Studies"),
    ("MOLCLBIO", "Molecular & Cellular Biology"),
    ("MUSIC", "Music"),
    ...
    ("NEUROS&B", "Neuroscience & Behavior"),
    ("NURSING", "Nursing"),
    ("NUTRITN", "Nutrition"),
    ("OIM", "Operations & Info Management"),
    ("ORG&EVBI", "Organismic & Evolutionary Biol"),
    ("PHIL", "Philosophy"),
    ("PHYSICS", "Physics"),
    ("PLANTBIO", "Plant Biology"),
    ("POLISH", "Polish"),
    ("POLISCI", "Political Science"),
    ("PO@MIC", "Political Science @ MIC"),
    ("POLYMER", "Polymer Science & Engineering"),
    ("PORTUG", "Portuguese"),
    ("PORTUGED", "Portuguese-Student Teaching"),
    ("PSYCH", "Psychology & Brain Sciences"),
    ...
    ("SPHHS", "School of Pub Hlth & Hlth Sci"),
    ("SPP", "School of Public Policy"),
    ("SC@MIC", "Science @ MIC"),
    ("SRVCLRNG", "Service Learning"),
    ("SLAVIC", "Slavic"),
    ("SEESTU", "Slavic & E European Studies"),
    ("SOCBEHAV", "Social & Behavioral Science"),
    ("STPEC", "Social Thought & Polic. Econ"),
    ("SOCIOL", "Sociology"),
    ("SPANISH", "Spanish"),
    ...
    ("VT@MIC", "Vet Tech @ Mt. Ida College"),
