    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('PS', 'Problem Set'), ('QZ', 'Quiz'), ('EX', 'Exam'), (
                    'PR', 'Presentation'), ('ES', 'Essay'), ('PJ', 'Project')], default='PS', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 related_name='day_entries', to='api.Assignment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='day_entries', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='course',
            ...
            field=models.ManyToManyField(
                related_name='courses', through='api.Enrollment', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='assignment',
            name='course',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='assignments', to='api.Course'),
        ),
    ]
